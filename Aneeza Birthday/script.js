...
// --- Content ---
const stopsData = [
  { id: 's1', date: 'August, 2024', note: "I found you online. Or maybe you found me. Either way, something walked in without knocking and rearranged everything.", icon: 'star', song: { title: '— song title —', artist: '— artist —', quote: '— paste a line from the song here, about an unexpected beginning —', href: '#' } },
